...
with(this){return _c('h2',{attrs:{"id":"locating-persons-by-category-and-description-or-by-tag-find"}},[_v("Locating persons by category and description or by tag: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#locating-persons-by-category-and-description-or-by-tag-find","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find c/<category> d/<description>")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/<tag>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Find anyone in the address book with matching category and description or tag only")]),_v(" "),_c('li',[_v("Category refers to a field a person has, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("phone")]),_v(" and etc.")]),_v(" "),_c('li',[_v("Tag refers to the specific type of person in the address book, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friends")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("neighbours")]),_v(" and etc.")])])}
},function anonymous(
) {
