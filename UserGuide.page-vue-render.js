...
with(this){return _c('h3',{attrs:{"id":"adding-an-entry-to-a-person-addcategory"}},[_v("Adding an entry to a person : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addCategory")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-an-entry-to-a-person-addcategory","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"deleting-a-category-of-a-person-deletecategory"}},[_v("Deleting a category of a person : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteCategory")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-a-category-of-a-person-deletecategory","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"organised-groupings-of-contacts-coming-in-v2-0"}},[_v("Organised groupings of contacts "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("[coming in v2.0]")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#organised-groupings-of-contacts-coming-in-v2-0","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
